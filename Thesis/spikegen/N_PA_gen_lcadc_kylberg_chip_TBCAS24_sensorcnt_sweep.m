...
mr_cnt_array = [18*18];      % example MR counts
...
trialcnt=40; %40;  % how many trials per class to use
...
for h=1:hem_cnt
    ...
    %[stim_exp] = read_textures('/users/micas/malea/Documents/all_scripts-slayer/tactile_dataset/FricScans',tex_dataset,tex_cnt,trialcnt,randtex,randtex_indices,fs_stim,stim_os,mr_cnt,scanv,scandir,0,spatialres);
