...
module arb_3 ( 
	...
	input [1:0] lni,		// requests from default taxel -> 4th taxel is tied to 0 (3x3 array)
	output wire [1:0] n_lno,  // acks for default taxel	
	output wire ro,
	input n_ri
...
wire [1:0] ro_0; // all requests from 1st tier of arbiters
...
wire [1:0] n_ri_0; // all acks for 1st tier of arbiters
...
// extra first-layer arbiters for increased delay (hold time)
arb_2 r0_0 ( .l1i( lni[0] ), .l2i( 1'b0 ), .n_l1o( n_lno[0] ), .n_l2o(  ), .ro( ro_0[0] ), .n_ri( n_ri_0[0] ));
arb_2 r0_1 ( .l1i( lni[1] ), .l2i( 1'b0 ), .n_l1o( n_lno[1] ), .n_l2o(  ), .ro( ro_0[1] ), .n_ri( n_ri_0[1] ));
...
//arb_2 r1_0 ( .l1i( lni[0] ), .l2i( lni[1] ), .n_l1o( n_lno[0] ), .n_l2o( n_lno[1] ), .ro( ro ), .n_ri( n_ri ));//
arb_2 r1_0 ( .l1i( ro_0[0] ), .l2i( ro_0[1] ), .n_l1o( n_ri_0[0] ), .n_l2o( n_ri_0[1] ), .ro( ro ), .n_ri( n_ri ));//
