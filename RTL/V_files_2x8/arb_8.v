...
module arb_8 ( 
	...
	input [7:0] lni,		// requests from default taxel -> 4th taxel is tied to 0 (3x3 array)
	output wire [7:0] n_lno,  // acks for default taxel	
	output wire ro,
	input n_ri
...
wire [3:0] ro_0; // all requests from 1st tier of arbiters
wire [1:0] ro_1; // all requests from 1st tier of arbiters
...
wire [3:0] n_ri_0; // all acks for 1st tier of arbiters
...
arb_2 r2_0 ( .l1i( ro_1[0] ), .l2i( ro_1[1] ), .n_l1o( n_ri_1[0]), .n_l2o( n_ri_1[1] ), .ro( ro ), .n_ri( n_ri ));
