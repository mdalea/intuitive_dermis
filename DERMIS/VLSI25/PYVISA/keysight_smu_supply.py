...
for run_id in range(0,int(1)): # perform N runs for averaging
    ...
    #time_arr_out, voltage_arr_outp = analyze(VOUTP_X0_INAMP,fin, vamp, vofs)  # capture screenshot, save csv, and other things
    #time_arr_out, voltage_arr_outn = analyze(VOUTN_X0_INAMP,fin, vamp, vofs)  # capture screenshot, save csv, and other things    
